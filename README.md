<!-- Header Banner -->
<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:00E676,100:00897B&height=200&section=header&text=Jay%20Lee&fontSize=60&fontColor=fff&animation=fadeIn&fontAlignY=38&desc=Building%20in%20Public%20%C2%B7%20Go%20%C2%B7%20Rust%20%C2%B7%20TS%20%C2%B7%20Swift&descAlignY=58&descAlign=50" />
</div>
...
I build **open-source tools across the stack** — from Rust CLIs and Go services to AI SaaS and native Swift apps.
Most of my work is **scratching my own itch**, then open-sourcing it. If you find it useful, even better.

```text
🎯  Focus       AI tooling · personal automation · web3 infra · systems programming
🔨  Style       Ship small, iterate fast, polyglot by curiosity
🌱  Always      Learning a new language / framework every quarter
📬  Reach me    Issues / PRs welcome on any repo
```
...
I deliberately keep a polyglot stack — the right tool for the right job.
...
<div align="center">
  ...
  <br/>
  <i>"Build in public. Ship in Rust. Talk to LLMs. Repeat."</i>
</div>
